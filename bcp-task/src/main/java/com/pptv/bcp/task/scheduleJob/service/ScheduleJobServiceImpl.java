...
//package com.pptv.scheduleJob.service;
//
...
//
//import com.pptv.scheduleJob.entity.ScheduleJob;
//
///**
// * 定时任务 service
// * @author mingyangyang
...
//						scheduleJob.setCronExpression("重复次数:"	+ (simple.getRepeatCount() == -1 ? "无限"
...
//				.withIdentity(key).withSchedule(CronScheduleBuilder.cronSchedule(cron)).build();
